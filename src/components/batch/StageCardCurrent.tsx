 ...
 */
function calculateProgress(daysElapsed?: number, daysMin?: number | null, daysMax?: number | null): number {
      ...
      <CardContent className="space-y-6">
        ...
        {(stage.days_min || stage.days_max) && (
          <div className="space-y-2">
            ...
            <Progress value={progress} className="h-2" aria-label={`Postęp etapu: ${progress.toFixed(0)}%`} />
        ...
        {stage.instructions && (
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="instructions" className="border-none">
              ...
              <AccordionContent>
                <div className="text-sm text-gray-600 whitespace-pre-wrap pl-6 pt-2">{stage.instructions}</div>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        )}
